package com.example.mvvmtipcalculator.model

import org.junit.Assert.assertEquals
import org.junit.Before
import org.junit.Test

// Test case classes must mirror the package of the classes they are testing
class RestaurantCalculatorTest {
    ...
    fun testCalculateTip() {
        ...
        val testVals = listOf<TipCalculation>(baseTc.copy(
            tipPct = 25, tipAmount = 2.5, grandTotal = 12.50),
